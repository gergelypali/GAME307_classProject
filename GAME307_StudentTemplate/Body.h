...
public:
    ...
    virtual void setVel(Vec3 newVel) { vel = newVel; };
    virtual void setOrientation(float newOri) { orientation = newOri; };
    virtual void setRotation(float newRot) { rotation = newRot; };
    virtual void setAcceleration(MATH::Vec3 newAccel) { accel = newAccel; };
    virtual void setAngular(float newAngular) { angular = newAngular; };
};
